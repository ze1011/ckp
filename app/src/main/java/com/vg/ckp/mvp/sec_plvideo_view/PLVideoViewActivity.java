package com.vg.ckp.mvp.sec_plvideo_view;
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case PLOnInfoListener.MEDIA_INFO_VIDEO_RENDERING_START:
                    LogUtils.d( "first video render time: " + extra + "ms");
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                ...
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    LogUtils.d( "failed to open player !");
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    LogUtils.d( "failed to seek !");
                    return true;
                case PLOnErrorListener.ERROR_CODE_CACHE_FAILED:
                    LogUtils.d( "failed to cache url !");
                    break;
                default:
                    LogUtils.d( "unknown error !");
                    break;
            }
            finish();
            return true;
